...
\usepackage{mathrsfs}
\usepackage{bm} %BoldMath: para las ingresar negrita en ecuaciones
\usepackage{nicefrac} %Para las fracciones
\usepackage{textcomp} %Para habilitar "°" symbol en texto
...
%-----------BibLaTeX format-----------------------
\usepackage{csquotes}
\usepackage[citestyle=verbose-ibid,backend=biber,bibstyle=numeric]{biblatex}
